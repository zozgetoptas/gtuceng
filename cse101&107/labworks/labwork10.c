...
void show_letter_grade_statistics(student arr[], int n)
{
    ...
    printf("\n%d students got letter 'A'\n", count_a);
    printf("%d students got letter 'B'\n", count_b);
    printf("%d students got letter 'C'\n", count_c);
    printf("%d students got letter 'D'\n", count_d);
    printf("%d students got letter 'F'\n", count_f);
}

void show_stars(student arr[], int n)
{
    int count_a = 0, count_b = 0, count_c = 0, count_d = 0, count_f = 0;
...
void find_the_longest_name(student arr[], int n)
{
    for (int i = 0; i < n; i++)
        arr[i].len = strlen(arr[i].name);
    int i = 1;
    size_t longest = arr[0].len;
    while(i < n)
    {
...
int main(void)
{
    ...
    while(i < count)
    {
        students[i].len = strlen(students[i].name);
        i++;
    }
    fclose(file);
    ...
    while (1)
    {
        ...
        switch (choice)
        {
            ...
            case 5:
                ...
                break;
            case 6:
                find_the_longest_name(students, count);
                break;
            case 7:
                show_stars(students, count);
                break;
            case 0:
                printf("\n\nQuit selected!\n");
                return 0;
